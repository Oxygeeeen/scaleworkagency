...
const pages = {
  privacy: { title: "Privacy notice", intro: "This notice explains the information ScaleWorkAgency collects through project enquiries and contributor applications, why it is used and the choices available to you.", sections: [
  ...
  terms: { title: "Website terms", intro: "These draft terms describe the intended use of the ScaleWorkAgency website. Project services and contributor assignments are governed by separate written agreements.", sections: [
  ...
  cookies: { title: "Cookie notice", intro: "This notice describes the intended cookie and analytics approach for the ScaleWorkAgency website.", sections: [
  ...
  "contributor-notice": { title: "Contributor privacy notice", intro: "This notice explains how information submitted by prospective and active freelance contributors is intended to be handled.", sections: [
